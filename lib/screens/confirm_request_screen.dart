...
class _ConfirmRequestScreenState extends State<ConfirmRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ clamp text scale لتفادي overflow
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      // ✅ Mini Map Preview (no map sdk needed)
                      _miniMapPreview(
                        lat: a.lat,
                        lng: a.lng,
                        title:
                            (a.address != null && a.address!.trim().isNotEmpty)
                                ? "فتح على الخريطة"
                                : "عرض على الخريطة",
  ...
  Widget _paymentChip({
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          gradient: selected ? _greenWhite : null,
          ...
          boxShadow: selected ? _greenGlow : null,
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon,
                size: 18, color: selected ? Colors.black : Colors.white70),
  ...
  Widget _ctaButton({
    ...
    return SizedBox(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(18),
          boxShadow: enabled ? _greenGlow : _shadowSm,
        ),
        child: ElevatedButton(
          ...
          child: Ink(
            decoration: BoxDecoration(
              gradient: enabled ? _greenWhite : null,
              color: enabled ? null : Colors.white.withOpacity(.10),
              borderRadius: BorderRadius.circular(18),
              border: Border.all(
                  color: enabled ? Colors.black.withOpacity(.10) : _stroke),
            ),
            child: Container(
